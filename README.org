...
** Starter Kit
   ...
   - [[https://github.com/tychoish/.emacs.d][tychoish emacs]] - Complete minimal emacs distribution and configuration focusing on fast start up time, daemon workflows, and native-emacs idioms.
