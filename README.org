...
*** Windows
    Download emacs from a GNU Mirror listed on the GNU Emacs Download & Installation page, and/or use the [[https://www.msys2.org][MSYS2]] pacman manager means by which emacs can be installed in Windows. Another option is to install emacs via the [[https://chocolatey.org/packages/Emacs][Chocolatey]] or [[https://github.com/lukesampson/scoop-extras/blob/master/bucket/emacs.json][scoop]] Windows package managers. A default install of Windows does not contain emacs.
