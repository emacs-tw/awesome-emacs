...
** File Manager
   ...
   - [[http://www.emacswiki.org/emacs/DiredMode][Dired]] - =[built-in]= A customizable great file manager in Emacs.
...
** Theme
   ...
   - [[https://github.com/bbatsov/solarized-emacs][Solarized]] - Solarized color theme.
   - [[https://github.com/kuanyui/moe-theme.el][moe-theme.el]] - A colorful eye-candy theme, which is customizable, and optimized for 256-colors.
