...
*** Error Checking
    ...
    - [[http://www.emacswiki.org/emacs/FlyMake][FlyMake]] - =[built-in]= An on-the-fly syntax checks on files using external tools.

** Programming Language

*** C/C++

    - [[https://github.com/Lindydancer/cmake-font-lock][cmake-font-lock]] - (Enhanced) Emacs Font-lock rules for CMake.
    - [[https://github.com/Sarcasm/irony-mode][irony-mode]] - A C/C++ minor mode for Emacs powered by libclang.
    - [[https://github.com/Andersbakken/rtags][rtags]] :star: - A c/c++ client/server indexer with for integration with emacs based on clang.
...
*** Ruby
    ...
    - [[https://github.com/zenspider/enhanced-ruby-mode][enh-ruby-mode]] - Major mode for editing Ruby files.
    ...
    - [[https://github.com/senny/rvm.el][rvm.el]] - Use rvm to manage ruby versions within emacs.
...
*** Web / JavaScript / CSS
    ...
    - [[http://web-mode.org/][web-mode]] - A major mode for editing various html templates (PHP, JSP, ASP, ERB...etc).
...
*** Haskell
    ...
    - [[https://github.com/haskell/haskell-mode][haskell-mode]] - A major mode for Haskell.
...
** Note
   ...
   - [[http://orgmode.org/][Org]] :star: - =[built-in]= Write notes, GTD, authoring, publish and wash dishes.
...
** Version control
   ...
   - [[http://magit.github.io/][Magit]] :star: - Interacting with git.
...
** LaTeX
   ...
   - [[http://www.emacswiki.org/emacs/LaTeXPreviewPane][latex-preview-pane]] - A minor mode for Emacs that enables you to preview your LaTeX files directly in Emacs.
...
Your contributions are always welcome! Please submit a pull request or create an issue to add a new package, library or software to the list(you are highly recommended to read [[CONTRIBUTING.org][CONTRIBUTING.org]]).
