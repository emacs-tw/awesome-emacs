...
*** C/C++
    ...
    - [[https://github.com/atilaneves/cmake-ide/][cmake-ide]] - Configures other packages to consider compile options like include paths from cmake projects to improve e.g. auto-completion.
...
*** Java
    ...
    - [[https://github.com/emacs-eclim/emacs-eclim][emacs-eclim]] - An Eclipse plugin that exposes Eclipse features through a server interface.
