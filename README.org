...
*** Browser
     ...
     - [[https://www.emacswiki.org/emacs/EmacsApplicationFramework][emacs-application-framework]] - A framework run any Qt5 program in Emacs, such as browser.
...
** Multimedia
   ...
   - [[https://github.com/hlolli/csound-mode]] - Emacs major mode for coding in Csound .
