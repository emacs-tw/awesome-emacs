...
** Interface Enhancement
   ...
   - [[https://github.com/zk-phi/sublimity][sublimity]] - smooth-scrolling, minimap and distraction-free mode (inspired by the sublime)

sublime editor)
   - [[http://www.emacswiki.org/emacs/download/ansi-color.el][ansi-color]] - translate ANSI escape sequences into faces (Note: doesn't support 256 color)
