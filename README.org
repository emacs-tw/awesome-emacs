...
*** Org-mode
    ...
    - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF Org Previewer, real-time rendering preview for org file.
...
** Version control
   ...
   - [[https://github.com/syohex/emacs-git-gutter][git-gutter]] - Indicates modified lines via git diff. [Unmaintained, consider using =diff-hl= instead.]
...
** Markdown
   ...
   - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF Markdown Previewer, real-time rendering preview for markdown file.
...
** PDF
   ...
   - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF PDF Viewer, using pymupdf, feature-rich and blazingly fast PDF Viewer in Emacs
...
*** Browser
     ...
     - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF Browser, full graphic support expected from any modern browser, with Vimium-like navigation so you don't need to use your mouse!
...
*** Web Feed
    ...
    - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF RSS Reader, multi-thread RSS reader with full graphical rendering.
...
*** File Transfer
    - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF File Sender, EAF File Receiver, EAF Air Share, transfer files on your computer with your phone within Emacs!
** DevOps
...
** Multimedia
   ...
   - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF Video Player & EAF Image Viewer, play videos and navigate images all in Emacs!
...
** Fun
   - [[https://github.com/manateelazycat/emacs-application-framework][Emacs Application Framework]] - EAF Camera, take photos in Emacs!
...
** Starter Kit
   ...
   - [[https://github.com/MatthewZMD/.emacs.d][M-EMACS]] - a beginner-friendly full-featured GNU Emacs configuration - all packed in README!
