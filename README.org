...
- [[#awesome-emacs][Awesome Emacs]]
  ...
  - [[#editing-enhancement][Editing Enhancement]]
    ...
    - [[#delete][Delete]]
    - [[#quotes--parenthesis--delimiters][Quotes & Parenthesis & Delimiters]]
...
*** Highlight
    ...
    # For contributors: Highlight file's content within buffer , NOT
    # include highlight current line, line number, or some others of
    # Emacs itself's UI.
...
*** Delete
   ...
   - [[https://www.emacswiki.org/emacs/DeleteSelectionMode][delete-selection-mode]] - =[build-in]= Auto delete selected region when typing, just like most of other modern text editors.
...
*** Quotes & Parenthesis & Delimiters

**** Insert & Edit

   - [[https://www.emacswiki.org/emacs/ElectricPair][electric-pair-mode]] - =[build-in]= Auto close, or insert matching delimiters: parentheses, braces, brackets, etc. ([[https://www.gnu.org/software/emacs/manual/html_node/emacs/Matching.html][GNU Manual]])
...
**** Highlight
   ...
   - [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Matching.html][show-paren-mode]] - =[build-in]= a minor mode to visualize parenthesis matching.
