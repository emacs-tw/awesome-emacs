...
**** JavaScript
     ...
     - [[https://github.com/thomblake/js3-mode/][js3-mode]] - A chimeric fork of js2-mode and js-mode.
     - [[https://github.com/abicky/nodejs-repl.el][nodejs-repl]] - Run Node.js REPL and communicate the process
...
#+BEGIN_QUOTE
External Guides:
- [[https://github.com/xiaohanyu/oh-my-emacs/blob/master/modules/ome-javascript.org][Oh My Emacs JavaScript]] - Config for combining JS3-mode, nodejs-repl and Tern to great effect
#+END_QUOTE
