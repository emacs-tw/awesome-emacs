...
** Theme
   ...
   - [[https://github.com/bbatsov/zenburn-emacs][Zenburn]] - /(dark)/ Vim' "Zenburn theme" ported to Emacs.


   #+BEGIN_QUOTE
   Above list is some of the most popular/installed themes. If still unsatisfied, you also can take a look of [[http://emacsthemes.caisah.info/][GNU Emacs Themes Gallery]] for screenshots of almost available all Emacs themes. 
   #+END_QUOTE
