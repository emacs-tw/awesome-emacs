...
** File Manager
   ...
   - [[https://github.com/raghavgautam/tramp-hdfs][tramp-hdfs]] - Browser HDFS in Emacs with dired using Tramp 
...
*** Operating System
	...
	- [[https://github.com/raghavgautam/osx-lib][osx-lib]] - Emacs functions for mac osx
	- [[https://github.com/benmaughan/spotlight.el][spotlight]] - Emacs package to query Mac OS X spotlight 
